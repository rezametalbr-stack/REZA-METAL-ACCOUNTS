        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-[var(--border-color)]">
              {loading ? (
                <tr>
                  <td colSpan={6} className="py-20 text-center text-[var(--text-secondary)] font-bold uppercase tracking-widest text-xs">Loading ledger...</td>
                </tr>
              ) : filteredCustomers.length === 0 ? (
                <tr>
                  <td colSpan={6} className="py-20 text-center text-[var(--text-secondary)] font-bold uppercase tracking-widest text-xs">No records found</td>
                </tr>
              ) : (
